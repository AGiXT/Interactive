...
export type Item = {
  ...
  import {
    ...
    VenetianMask,
    Workflow,
    LuListTodo, // Added ListTodo icon
  } from 'lucide-react'; // Import ListTodo
  import { TbMessageCirclePlus } from 'react-icons/tb';
  type NestedItem = {
    title: string;
    url: string;
  ...
  export const items: Item[] = [
    ...
    {
      title: 'Automation',
      icon: LuLink, // Consider changing this to something more generic like a gear or wrench
      items: [
        {
          title: 'Chains',
          icon: Workflow,
        ...
        },
        {
          // --- NEW ITEM FOR TASKS ---
          title: 'Tasks',
          icon: LuListTodo, // Using ListTodo icon
          url: '/tasks',
          // --- END NEW ITEM ---
        }
      ],
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: 'User Terms', url: '/docs/5-Reference/4-User Tems' },
          ],
        },
      ],
    },
